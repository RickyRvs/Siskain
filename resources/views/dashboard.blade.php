            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-6 items-start">
                ...
                <div class="xl:col-span-2 space-y-3">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <a href="{{ route('transactions.create') }}"
                           class="bg-white rounded-xl ring-1 ring-[#E7E1D3] shadow-sm p-5 flex items-start gap-4 hover:ring-[#D4A73C]/60 hover:shadow-md transition group">
                            <div class="w-11 h-11 shrink-0 rounded-lg bg-[#FBF0DA] text-[#B5842A] flex items-center justify-center group-hover:bg-[#F5E3B8]">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                                </svg>
                            </div>
                            <div>
                                <p class="text-sm font-medium text-[#1F2A24]">Transaksi Baru</p>
                                <p class="text-xs text-[#8A8272] mt-0.5">Catat penjualan baru</p>
                            </div>
                        </a>

                        <a href="{{ route('products.index') }}"
                           class="bg-white rounded-xl ring-1 ring-[#E7E1D3] shadow-sm p-5 flex items-start gap-4 hover:ring-[#D4A73C]/60 hover:shadow-md transition group">
                            <div class="w-11 h-11 shrink-0 rounded-lg bg-[#EAF3EE] text-[#2F6F4E] flex items-center justify-center group-hover:bg-[#DAEBE1]">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                                </svg>
                            </div>
                            <div>
                                <p class="text-sm font-medium text-[#1F2A24]">Produk & Stok</p>
                                <p class="text-xs text-[#8A8272] mt-0.5">Kelola produk dan jumlah stok</p>
                            </div>
                        </a>

                        <a href="{{ route('customers.index') }}"
                           class="bg-white rounded-xl ring-1 ring-[#E7E1D3] shadow-sm p-5 flex items-start gap-4 hover:ring-[#D4A73C]/60 hover:shadow-md transition group">
                            <div class="w-11 h-11 shrink-0 rounded-lg bg-[#E9F1F1] text-[#1B6E6E] flex items-center justify-center group-hover:bg-[#D9E9E9]">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div>
                                <p class="text-sm font-medium text-[#1F2A24]">Customer</p>
                                <p class="text-xs text-[#8A8272] mt-0.5">Lihat dan tambah data pelanggan</p>
                            </div>
                        </a>

                        <a href="{{ route('transactions.index') }}"
                           class="bg-white rounded-xl ring-1 ring-[#E7E1D3] shadow-sm p-5 flex items-start gap-4 hover:ring-[#D4A73C]/60 hover:shadow-md transition group">
                            <div class="w-11 h-11 shrink-0 rounded-lg bg-[#FBEAE6] text-[#B5482E] flex items-center justify-center group-hover:bg-[#F5D9D2]">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                            </div>
                            <div>
                                <p class="text-sm font-medium text-[#1F2A24]">Riwayat Transaksi</p>
                                <p class="text-xs text-[#8A8272] mt-0.5">Cari dan cetak ulang transaksi lama</p>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl ring-1 ring-[#E7E1D3] shadow-sm p-5 xl:min-h-[21rem] flex flex-col">
                    ...
                    @forelse ($recentTransactions as $trx)
                        <a href="{{ route('transactions.show', $trx) }}" class="flex items-center justify-between py-2.5 border-b border-[#EFEAE0] last:border-0 hover:bg-[#F6F3EC] -mx-2 px-2 rounded-lg">
